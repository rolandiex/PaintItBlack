...
#define PGETTALKTYPE_FN signed int __fastcall proxyGetTalkType(void* this_obj, DWORD EDX, char* a2, int a3, char* a4)
...
#define SESSION_DATA                      \
    ...
    /* 0x638  */ BYTE offset2[0x484];     \
	/* 0xABC  */ int sex;				  \
	/* 0xAC0  */ BYTE offset3[0x744];		\
    /* 0x1204 */ ULONG aid;               \
    /* 0x1208 */ ULONG gid;               \
    /* 0x120C */ BYTE offset4[0x8];       \
    /* 0x1214 */ int job;                 \
    /* 0x1218 */ int exp;                 \
    /* 0x121C */ int level;               \
    /* 0x1220 */ int point;               \
    ...
    /* 0x1230 */ BYTE offset5[0xA0];      \
    /* 0x12D0 */ int jobnextexp;          \
    /* 0x12D4 */ int jobexp;				\
	/* 0x12D8 */ BYTE offset6[0x4480];		\
