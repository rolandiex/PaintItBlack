//This script searches for g_renderer_old related addresses.
//- DrawScene (Function address)
//- Renderer (Global address of the renderer_old object)
...
public class renderer_old extends GhidraScript {
	PiBLib pib;
